有一些文件夹和文件，分成3个板块：
第一个是XEP (全称为XEuclidea Puzzle)，一些精选的作图题。
...
Impossible Straightedge and Compass Constructions简称为isacc

第三个是套题(Set Similar Questions)，由2个及以上的相似题目构成。

答案在Solutions，这些答案可能不是最简的，欢迎大家破纪录！

There are some folders and files, divided into three sections:
The first one is XEP (The full name of XEP is XEuclidea Puzzle), some prime of puzzles.

The second one is the draft box, where all future updated puzzles will be placed.
If a puzzle has a good feedback, it may be transferred to the XEP section.
You can add puzzles inside, just fill out the form and put pictures.
...
The third one is a set of puzzles, consisting of two or more similar puzzles.

The solution is in 'Solutions' folder, and there solutions may not be the limit of moves. Welcome to break the record!
